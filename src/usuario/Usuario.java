/**
 * Classe de interação com o UsuÃ¡rio
 */
package usuario;
...
public class Usuario {
		...
		try {
			...
			while(true) {
				...
				case 9:
					...
					break;
				case 10:
					//Consultar vendas pelo perÃ­odo em ordem de cliente e data da venda decrescente
	...
	/**
	 * @return opção escolhida pelo usuÃ¡rio
	 */
	private static int Menu() {
		...
		try {
			/*Clientes (incluir um novo cliente, alterar o cliente via cpf, excluir um cliente via cpf)
			 ...
			 Vendas (incluir uma venda para um cliente, excluir uma venda de um cliente via código da venda, consultar as vendas pelo perÃ­odo em ordem de cliente e data da venda decrescente)*/
			do {
				System.out.println("|*************************************************************|");
